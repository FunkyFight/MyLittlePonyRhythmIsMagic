...
public class SeeSawScene : Scene
{
    ...
    private void SetupAnimations()
    {
        RainbowState = new AnimationStateMachine()
            ...
            .AddTransition("land", "idle", () => RainbowState.StateProgress >= 1f)
